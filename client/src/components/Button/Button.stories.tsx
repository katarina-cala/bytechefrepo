...
const meta = {
    ...
    argTypes: {
        children: {
            ...
            description: 'Custom content to display inside the button - only applied when no label is provided',
        ...
        icon: {
            control: {type: 'select'},
            description:
                'Icon to display on the button - can be any icon sent as a `ReactElement` through the `icon` prop.',
        ...
        label: {
            control: {type: 'select'},
            description:
                'Button text content - **always** takes precedence over custom content that is passed through the `children` prop.',
            table: {
                type: {summary: 'string'},
            },
        ...
        size: {
            control: {type: 'select'},
            description:
                'Size variant of the button - icon sizes should be used with the `icon` prop and without a label or custom content.',
...
export const TextButtonsSizeVariants: Story = {
    render: () => (
...
export const IconButtonsSizeVariants: Story = {
    render: () => (
        <div className="flex items-center gap-4">
...
export const TextButtonsStyleVariants: Story = {
    render: () => (
...
export const IconButtonsStyleVariants: Story = {
    render: () => (
        <div className="flex flex-wrap items-center gap-4">
...
export const TextButtonsWithIcons: Story = {
    render: () => (
        <div className="flex flex-wrap items-center gap-4">
    ...
    parameters: {
        docs: {
            description: {
                story: 'Different sizes and variants of text buttons with icons passed as a prop.',
            },
        },
    },
};
