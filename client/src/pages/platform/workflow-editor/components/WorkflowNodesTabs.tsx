...
const WorkflowNodesTabs = ({
    ...
    useEffect(() => {
        if (!hideClusterElementComponents) {
            setActiveTab('clusterElements');
        } else if (!hideTriggerComponents) {
            setActiveTab('triggers');
        } else if (!hideActionComponents) {
            setActiveTab('components');
        } else if (!hideTaskDispatchers) {
            setActiveTab('taskDispatchers');
        }
    }, [hideClusterElementComponents, hideTriggerComponents, hideActionComponents, hideTaskDispatchers]);
